 ...
 *   https://datatables.net/download/#bs5/dt-1.11.3/fc-4.0.0/fh-3.2.0/r-2.2.9
 *
 * Included libraries:
 *   DataTables 1.11.3, FixedColumns 4.0.0, FixedHeader 3.2.0, Responsive 2.2.9
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.11.3/fc-4.0.0/fh-3.2.0/r-2.2.9",
