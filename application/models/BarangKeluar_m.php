...
{
  private $tabel = "t_barang_keluar";

  function getAll_ignited()
  {
    $this->datatables->select("id_brg_keluar,jumlah,keterangan,tanggal,penerima,nama_barang_upah,jenis_brg,merk_brg,ukuran_brg,satuan,tipe");
    ...
    $this->datatables->add_column(
      'view',
      '<button class="btn btn-icon icon-left btn-warning" id-pk="$1" id="bk_u">
                                                    <i class="fas fa-edit"></i>
                                                    Ubah
                                                </button>
                                                <button class="btn btn-icon icon-left btn-danger" id-pk="$1" id="bk_d">
