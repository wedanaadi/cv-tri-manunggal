        ...
        <div class="card-footer">
          <div class="row">
            <div class="col text-right">
              <a href="<?= base_url('ProgressProyek_c/detailforadmin/' . json_decode($idproyek)) ?>" onclick="goBack()" type="button" id="cancel" class="btn btn-icon icon-left btn-light">
  ...
  var tabel = $("#progress_tabel").DataTable({
    ...
    columns: [{
      ...
      },
      {
        "data": "countprogress",
        render: function(v) {
          return `<button type="button" class="btn btn-primary position-relative">
                    Progress
