<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?= base_url('assets/img/foto/' . $photo[0]->photo_name) ?>" alt="First slide">
    </div>
    <?php for ($i = 1; $i < count($photo); $i++) : ?>
      <div class="carousel-item">
        <img class="d-block w-100" src="<?= base_url('assets/img/foto/' . $photo[$i]->photo_name) ?>" alt="Third slide">
      </div>
    <?php endfor; ?>
  </div>
