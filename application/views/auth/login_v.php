      ...
      <div class="row">
        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
          <div class="login-brand">
            <img src="<?php echo base_url(); ?>assets/img/logo/logo.png" alt="logo" width="100">
          </div>

          <div class="card card-primary">
            <div class="card-header">
              <h3>CV Tri Manunggal</h3>
            </div>
  ...
  $('#auth_f').on('submit', function(e) {
    ...
    $.ajax({
      ...
      success: function(respon) {
        if (respon.action === '1') {
          notifsukses('Login', 'Login Berhasil');
          setTimeout(function() {
            window.location.href = "<?= base_url('Dashboard_c') ?>";
          }, 1000);
        } else {
          notifgagalcustom('Login', respon.msg);
        }
      }
    });
    return false;
