      ...
      <?php if ($this->session->userdata('hakakses') === '1' || $this->session->userdata('hakakses') === '4') : ?>
        <li class="<?= $this->uri->segment(1) == 'Kegiatan_c' || $this->uri->segment(1) == 'JenisProyek_c' || $this->uri->segment(1) == 'OrderProyek_c' || $this->uri->segment(1) == 'JadwalProyek_c' || $this->uri->segment(1) == 'BarangUpah_c' ? 'active' : ''; ?>">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="<?= $this->uri->segment(1) == 'JadwalProyek_c' && $this->uri->segment(2) == 'index' ? 'active' : ''; ?>"><a class="<?= $this->uri->segment(1) == 'JadwalProyek_c' && $this->uri->segment(2) == 'index' ? 'nav-link beep beep-sidebar' : 'nav-link'; ?>" href="<?php echo base_url(); ?>JadwalProyek_c/index">Data Jadwal Proyek</a></li>
          </ul>
        </li>
      <?php endif; ?>
