        ...
        <div class="col-12 col-md-12 col-lg-12">
          <div class="card">
            <div class="card-header">
              <a href="<?= base_url() ?>Kegiatan_c/addKegiatan" class="btn btn-icon icon-left btn-primary note-btn" id="kegiatan_t">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped" id="kegiatan_tabel" style="width:100%">
                  <thead>
                    <tr>
                      <th>
                        #
...
<script>
  ...
  var tabel = $("#kegiatan_tabel").DataTable({
    ...
    serverSide: true,
    ajax: {
      "url": "<?php echo base_url() . 'Kegiatan_c/ignited_data' ?>",
      "type": "POST"
    },
    columns: [{
        "data": null,
  ...
  $(document).on('click', '#k_d', function() {
    console.log('delete');
    isSave = 0;
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          type: "POST",
          url: "<?= base_url() ?>Kegiatan_c/hapus/" + id,
        ...
        notifgagal('Data Kegiatan', 'dihapus');
      }
    })
  });

  $(document).on('click', '#k_detail', function() {
    const id = $(this).attr('id-pk');
    $.ajax({
      type: "GET",
      dataType: "JSON",
      url: "<?= base_url(); ?>Kegiatan_c/form/" + id,
      success: function(respon) {
